class ToplamBorcunVarliklaraOraniFinansalKaldiracGenisYorum {
  String? companyCode;
  String? companyName;
  String? mainCategory;
  String? subCategory;
  ...
  ToplamBorcunVarliklaraOraniFinansalKaldiracGenisYorum({
    this.companyCode,
    this.companyName,
    this.mainCategory,
    this.subCategory,
  ...
  factory ToplamBorcunVarliklaraOraniFinansalKaldiracGenisYorum.fromJson(
